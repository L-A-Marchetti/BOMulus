...
export namespace core {
	...
	export class Component {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.lifecycle_status = this.convertValues(source["lifecycle_status"], MSValue);
	        this.rohs_status = this.convertValues(source["rohs_status"], MSValue);
	        this.suggested_replacement = this.convertValues(source["suggested_replacement"], MSValue);
	        ...
	        this.supplier_description = this.convertValues(source["supplier_description"], MSValue);
	        this.user_manufacturer = source["user_manufacturer"];
	        this.supplier_manufacturer = this.convertValues(source["supplier_manufacturer"], MSValue);
	        this.category = this.convertValues(source["category"], MSValue);
	        this.product_detail_url = this.convertValues(source["product_detail_url"], MSValue);
