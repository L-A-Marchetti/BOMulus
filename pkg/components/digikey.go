...
func APIRequestToDigiKey(workspace workspaces.Workspace, i int, done *chan struct{}) error {
	select {
	case <-*done:
	...
	default:
		...
		*/
		processAnalysis(workspace, ApiResponse{}, apiResponse, i, nil, "Digikey", done)
		return nil
	}
}
